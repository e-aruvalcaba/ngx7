module.exports = function() {	
	...
	var previewNode = document.querySelector("#template-rtl");
	previewNode.id = "";
	var previewTemplate = previewNode.parentNode.innerHTML;
	previewNode.parentNode.removeChild(previewNode);
	console.log('aicio');

	var myDropzone = new Dropzone(document.getElementById('dropzoneReceiver-rtl'), { // Make the whole body a dropzone
