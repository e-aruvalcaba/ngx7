(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('@angular/router'), require('@cemex-core/angular-services-v7'), require('@cemex-core/angular-localization-v7'), require('@cemex-core/events-v7'), require('rxjs'), require('rxjs/operators'), require('@angular/http'), require('@angular/common'), require('@angular/forms'), require('@angular/core'), require('@angular/flex-layout'), require('@cemex/cmx-dialog-v7'), require('@cemex/cmx-button-v4')) :
    typeof define === 'function' && define.amd ? define('@cemex/cmx-nav-header-v7', ['exports', '@angular/platform-browser', '@angular/router', '@cemex-core/angular-services-v7', '@cemex-core/angular-localization-v7', '@cemex-core/events-v7', 'rxjs', 'rxjs/operators', '@angular/http', '@angular/common', '@angular/forms', '@angular/core', '@angular/flex-layout', '@cemex/cmx-dialog-v7', '@cemex/cmx-button-v4'], factory) :
    (factory((global.cemex = global.cemex || {}, global.cemex['cmx-nav-header-v7'] = {}),global.ng.platformBrowser,global.ng.router,global.angularServicesV7,global.angularLocalizationV7,global.eventsV7,global.rxjs,global.rxjs.operators,global.ng.http,global.ng.common,global.ng.forms,global.ng.core,global.ng['flex-layout'],global.cmxDialogV7,global.cmxButtonV4));
}(this, (function (exports,platformBrowser,router,angularServicesV7,angularLocalizationV7,eventsV7,rxjs,operators,http,common,forms,core,flexLayout,cmxDialogV7,cmxButtonV4) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CmxNavHeaderComponent = /** @class */ (function () {
        function CmxNavHeaderComponent(sessionService, _translation, eventBroadcaster, countryConfigService, renderer, http$$1, router$$1, sanitizer, isRTL) {
            ...
            this.clickMenuButton = new core.EventEmitter();
            // tslint:disable:no-output-on-prefix
            this.onSelectItemSearchEvent = new core.EventEmitter();
            this.onViewAllResultEvent = new core.EventEmitter();
            /**
             * @deprecated Subscribe to Broadcaster's DCM_APP_LOGOUT event instead
             */
            this.onLogout = new core.EventEmitter();
            this.onLanguageChange = new core.EventEmitter();
            this.rtl = false;
            ...
            this.notificationAction = new core.EventEmitter();
            this.showAllNotifications = new core.EventEmitter();
            if (isRTL !== undefined) {
                this.rtl = isRTL;
            }
            this.setUserInfo();
         ...
         */
            function () {
                var _this = this;
                this.eventBroadcaster.on(eventsV7.Broadcaster.DCM_LANGUAGE_CHANGE).subscribe(( /**
                 * @return {?}
                 */function () {
                    _this.setFeedback();
                }));
         ...
         */
            function () {
                ...
                if (this.searchInput !== undefined) {
                    /** @type {?} */
                    var inputStream = rxjs.fromEvent(this.searchInput.nativeElement, 'keyup').pipe(operators.debounceTime(1), operators.distinctUntilChanged());
            ...
            function (changes) {
                 ...
                 */function (notificationsDict) {
                        ...
                        try {
                            ...
                            try {
                                if (notificationKeys_1_1 && !notificationKeys_1_1.done && (_a = notificationKeys_1.return))
                                    _a.call(notificationKeys_1);
                            }
                            finally {
                                if (e_2)
                                    throw e_2.error;
         ...
         */
            function (language) {
                ...
                this._showUserProfile = false;
                this.eventBroadcaster.broadcast(eventsV7.Broadcaster.DCM_LANGUAGE_CHANGE, language.languageISO);
            };
        /**
         * @param {?} notification
         * @return {?}
        ...
        CmxNavHeaderComponent.propDecorators = {
            countrySupportContactModal: [{ type: core.ViewChild, args: ['countrySupportContactModal',] }],
            clickMenuButton: [{ type: core.Output }],
            onSelectItemSearchEvent: [{ type: core.Output }],
            onViewAllResultEvent: [{ type: core.Output }],
            onLogout: [{ type: core.Output }],
            onLanguageChange: [{ type: core.Output }],
            rtl: [{ type: core.Input }],
            useLanguageSelector: [{ type: core.Input }],
            showCountrySupportContact: [{ type: core.Input }],
            useInternalSettings: [{ type: core.Input }],
            closeNotificationsOnCLick: [{ type: core.Input }],
            customPathSettings: [{ type: core.Input }],
            disabledProfile: [{ type: core.Input }],
            feedbackDialog: [{ type: core.ViewChild, args: ['feedbackDialog',] }],
            activeSearch: [{ type: core.Input }],
            searchServiceList: [{ type: core.Input }],
            notificationService: [{ type: core.Input }],
            notificationAction: [{ type: core.Output }],
            searchInput: [{ type: core.ViewChild, args: ['searchInput',] }],
            showAllNotifications: [{ type: core.Output }]
        };
    ...
    var CmxNavHeaderModule = /** @class */ (function () {
        ...
        CmxNavHeaderModule.decorators = [
            { type: core.NgModule, args: [{
                        ...
                        imports: [flexLayout.FlexLayoutModule, forms.FormsModule, forms.ReactiveFormsModule, common.CommonModule, cmxDialogV7.CmxDialogModule, cmxButtonV4.CmxButtonModule],
                    },] }
        ];
    ...
    exports.HEADER_NOTIFICATION_PUSH = HEADER_NOTIFICATION_PUSH;
    exports.HEADER_NOTIFICATION_UPDATE = HEADER_NOTIFICATION_UPDATE;
    exports.CmxNavHeaderComponent = CmxNavHeaderComponent;
    exports.CmxNavHeaderModule = CmxNavHeaderModule;
...
//# sourceMappingURL=cemex-cmx-nav-header-v7.umd.js.map