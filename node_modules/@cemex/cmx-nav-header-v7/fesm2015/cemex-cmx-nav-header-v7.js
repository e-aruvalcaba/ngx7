 ...
 */
/** @type {?} */
const HEADER_NOTIFICATION_UPDATE = 'cmx-nav-header_notification-update';
/** @type {?} */
const HEADER_NOTIFICATION_PUSH = 'cmx-nav-header_notification-push';

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CmxNavHeaderComponent {
    /**
     * @param {?} sessionService
     * @param {?} _translation
     * @param {?} eventBroadcaster
     * @param {?} countryConfigService
     * @param {?} renderer
     * @param {?} http
     * @param {?} router
     * @param {?} sanitizer
     * @param {?} isRTL
     */
    constructor(sessionService, _translation, eventBroadcaster, countryConfigService, renderer, http, router, sanitizer, isRTL) {
     ...
     * @return {?}
     */
    get _notificationsToShow() {
        /** @type {?} */
        const result = this._allNotifications.sort((/**
         * @param {?} notif1
         * @param {?} notif2
         * @return {?}
         */
    ...
    get language() {
        /** @type {?} */
        const tmp = this._languages.filter((/**
         * @param {?} lang
         * @return {?}
         */
    ...
    ngOnInit() {
        ...
        if (this._enableNotifications) {
            ...
            (event) => {
                ...
                /** @type {?} */
                const pushedNotification = this._notificationService.mapNotification(notification);
                // get list of notifications by type notification
                /** @type {?} */
                const _notifications = this._allNotificationDict[pushedNotification.typeNotification];
    ...
    ngAfterViewInit() {
        if (this.searchInput !== undefined) {
            /** @type {?} */
            const inputStream = fromEvent(this.searchInput.nativeElement, 'keyup').pipe(debounceTime(1), distinctUntilChanged());
            ...
            (event) => {
                ...
                /** @type {?} */
                const listResultLength = this.getListResult().length;
                if (event.code === 'Enter' && event.target.value && event.target.value !== '') {
                    ...
                    for (const subscription of this._subscriptionList) {
                        /** @type {?} */
                        const localSub = subscription.executeService(event.target.value).subscribe((/**
                         * @param {?} result
                         * @return {?}
                         */
                        (result) => {
    ...
    ngOnChanges(changes) {
        if (changes.notificationService && changes.notificationService.currentValue) {
            ...
            (notificationsDict) => {
                ...
                this._allNotifications = [];
                /** @type {?} */
                const tmpKeys = Object.keys(notificationsDict);
                /** @type {?} */
                const notificationKeys = tmpKeys.sort();
    ...
    setUserInfo() {
        if (this.sessionService.userProfile && this.sessionService.userProfile !== undefined) {
            ...
            /** @type {?} */
            const firstName = this._userProfile.firstName === 'undefined' || this._userProfile.firstName.trim() === null
                ? ''
                : this._userProfile.firstName.substring(0, 1);
            /** @type {?} */
            const lastName = typeof this._userProfile.lastName === 'undefined' || this._userProfile.lastName.trim() === null
                ? ''
     ...
     * @return {?}
     */
    openCountrySupportContactModal() {
    ...
    goToSettings() {
        /** @type {?} */
        const path = this.customPathSettings && this.useInternalSettings ? this.customPathSettings : '/settings';
    ...
    createCookie(name, value, days) {
        ...
        /** @type {?} */
        const domain = ((/** @type {?} */ (window))).SITE_DOMAIN || '';
        /** @type {?} */
     ...
     * @return {?}
     */
    clickAppNavigationOutside(event) {
     ...
     * @return {?}
     */
    callNotificationAction(notification) {
    ...
    getIconNotification(notification) {
        /** @type {?} */
        const result = notification.notificationIcon === undefined ? 'icon-warning-red' : notification.notificationIcon;
     ...
     * @return {?}
     */
    getMessageResult(noContainsData) {
     ...
     * @return {?}
     */
    compareNotificationFn(notif1, notif2) {
        ...
        (configCountry) => {
            if (configCountry !== null) {
                ...
                if (this._countryConfig.email && Boolean(this._countryConfig.email)) {
                    /** @type {?} */
                    const emailsArr = this._countryConfig.email.split(',');
                    this.emails = emailsArr;
                }
                if (this._countryConfig.phoneNumber && Boolean(this._countryConfig.phoneNumber)) {
                    /** @type {?} */
                    const phonesArr = this._countryConfig.phoneNumber.split(',');
...
/** @nocollapse */
CmxNavHeaderComponent.ctorParameters = () => [
    { type: SessionService },
