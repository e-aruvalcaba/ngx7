...
import { Injectable, Component, Input, HostBinding, Directive, HostListener, Host, Optional, Inject, Renderer2, ViewChild, NgModule, defineInjectable } from '@angular/core';
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class DataDismissDialogDirective {
    /**
     * @param {?} dialog
     */
    constructor(dialog) {
...
/** @nocollapse */
DataDismissDialogDirective.ctorParameters = () => [
...
class CmxDialogComponent {
    /**
     * @param {?} _renderer
     * @param {?} _cmxDialogService
     * @param {?} isRTL
     */
    constructor(_renderer, _cmxDialogService, isRTL) {
...
/** @nocollapse */
CmxDialogComponent.ctorParameters = () => [
    { type: Renderer2 },
...
/** @nocollapse */
CmxDialogBodyComponent.ctorParameters = () => [];
...
class CmxDialogConfirmationComponent {
    /**
     * @param {?} isRTL
     */
    constructor(isRTL) {
     ...
     * @return {?}
     */
    openAsError(message, messageDetail) {
...
/** @nocollapse */
CmxDialogConfirmationComponent.ctorParameters = () => [
    { type: Boolean, decorators: [{ type: Optional }, { type: Inject, args: ['RTL',] }] }
];
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CmxDialogFooterComponent {
    constructor() {
        this.widthStyle = '100%';
    }
}
...
/** @nocollapse */
CmxDialogFooterComponent.ctorParameters = () => [];
 ...
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CmxDialogHeaderComponent {
    constructor() { }
}
...
/** @nocollapse */
CmxDialogHeaderComponent.ctorParameters = () => [];

/**
 * @fileoverview added by tsickle
 * @suppress {checkTypes,extraRequire,missingOverride,missingReturn,unusedPrivateMembers,uselessCode} checked by tsc
 */
class CmxDialogGeneratorService {
    constructor() {
