(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs'), require('@angular/common'), require('@angular/core'), require('@angular/forms'), require('@cemex/cmx-button-v4/dist')) :
    typeof define === 'function' && define.amd ? define('@cemex/cmx-dialog-v7', ['exports', 'rxjs', '@angular/common', '@angular/core', '@angular/forms', '@cemex/cmx-button-v4/dist'], factory) :
    (factory((global.cemex = global.cemex || {}, global.cemex['cmx-dialog-v7'] = {}),global.rxjs,global.ng.common,global.ng.core,global.ng.forms,global.dist));
}(this, (function (exports,rxjs,common,i0,forms,dist) { 'use strict';
    ...
    var DataDismissDialogDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        DataDismissDialogDirective.ctorParameters = function () {
            return [
                { type: CmxDialogComponent, decorators: [{ type: i0.Host }] }
            ];
        };
    ...
    var CmxDialogComponent = /** @class */ (function () {
        function CmxDialogComponent(_renderer, _cmxDialogService, isRTL) {
            ...
            this.afterOpenedSubject = new rxjs.Subject();
            this.afterOpened$ = this.afterOpenedSubject.asObservable();
            this.afterClosedSubject = new rxjs.Subject();
        ...
        /** @nocollapse */
        CmxDialogComponent.ctorParameters = function () {
            return [
                { type: i0.Renderer2 },
                { type: CmxDialogService },
                { type: Boolean, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: ['RTL',] }] }
            ];
        };
        CmxDialogComponent.propDecorators = {
            dirAttr: [{ type: i0.HostBinding, args: ['attr.dir',] }],
            rtl: [{ type: i0.Input }],
            width: [{ type: i0.Input }],
            ...
            enableClose: [{ type: i0.Input }],
            enableHeader: [{ type: i0.Input }],
            enableFooter: [{ type: i0.Input }]
        };
    ...
    ***************************************************************************** */
    ...
    var CmxDialogConfirmationComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxDialogConfirmationComponent.ctorParameters = function () {
            return [
                { type: Boolean, decorators: [{ type: i0.Optional }, { type: i0.Inject, args: ['RTL',] }] }
            ];
        };
        CmxDialogConfirmationComponent.propDecorators = {
            dirAttr: [{ type: i0.HostBinding, args: ['attr.dir',] }],
            dialog: [{ type: i0.ViewChild, args: [CmxDialogComponent,] }],
            rtl: [{ type: i0.Input }],
    ...
    var CmxDialogFooterComponent = /** @class */ (function () {
        ...
        CmxDialogFooterComponent.propDecorators = {
            widthStyle: [{ type: i0.HostBinding, args: ['style.width',] }]
        };
    ...
    exports.DataDismissDialogDirective = DataDismissDialogDirective;
    exports.CmxDialogComponent = CmxDialogComponent;
    exports.CmxDialogBodyComponent = CmxDialogBodyComponent;
    exports.ConfirmationType = ConfirmationType;
    exports.CmxDialogConfirmationComponent = CmxDialogConfirmationComponent;
    exports.CmxDialogFooterComponent = CmxDialogFooterComponent;
    exports.CmxDialogHeaderComponent = CmxDialogHeaderComponent;
    exports.CmxDialogService = CmxDialogService;
    exports.CmxDialogGeneratorService = CmxDialogGeneratorService;
    exports.CmxDialogModule = CmxDialogModule;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=cemex-cmx-dialog-v7.umd.js.map