...
function compileSass(path, ext, file, callback) {
  ...
  bufferToVinyl.stream(compiledCss.css)
  .pipe(purify([INLINE_TEMPLATES.SRC, INLINE_TEMPLATES.MARKUP], {output: false, whitelist: ['*error*'] }))
  .pipe(gutil.buffer(function (err, b) {
    callback(null, b[0].contents);
  }));
}
