(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/router'), require('@angular/http'), require('rxjs'), require('rxjs/operators'), require('@cemex-core/constants-v2/dist'), require('@cemex-core/events-v7'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@cemex-core/angular-services-v7', ['exports', '@angular/router', '@angular/http', 'rxjs', 'rxjs/operators', '@cemex-core/constants-v2/dist', '@cemex-core/events-v7', '@angular/core'], factory) :
    (factory((global['cemex-core'] = global['cemex-core'] || {}, global['cemex-core']['angular-services-v7'] = {}),global.ng.router,global.ng.http,global.rxjs,global.rxjs.operators,global.dist,global.eventsV7,global.ng.core));
}(this, (function (exports,router,http,rxjs,operators,dist,eventsV7,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var HttpCemex = /** @class */ (function () {
        function HttpCemex(http$$1, projectSettings) {
            this.http = http$$1;
         ...
         */
            function (url, body, options, overrideHeader) {
                if (!this._validSettings) {
                    ...
                    return rxjs.Observable.throw(new Error(message));
                }
                /** @type {?} */
                var loptions = this.createAuthorizationHeader(options, overrideHeader);
        ...
        /** @nocollapse */
        HttpCemex.ctorParameters = function () {
            return [
                { type: http.Http },
    ...
    var SessionService = /** @class */ (function () {
        function SessionService(http$$1, eventBroadcaster, authTokenVersion) {
            this.http = http$$1;
            this.eventBroadcaster = eventBroadcaster;
            this.authTokenVersion = authTokenVersion;
            this.siteDomain = 'SITE_DOMAIN';
            this._siteDomain = window[this.siteDomain] || '';
            this._menuApplication = new rxjs.BehaviorSubject([]);
            this._currentLegalEntity = new rxjs.BehaviorSubject(null);
            this._userProfile = null;
            this._beforeLogout = null;
            if (authTokenVersion) {
                switch (authTokenVersion.toLocaleLowerCase()) {
                    case 'v6':
                        this._endpoint = dist.SessionServiceConstants.LOGIN_TOKEN_V6;
                        break;
                    default:
                        this._endpoint = dist.SessionServiceConstants.LOGIN_TOKEN_DEFAULT;
                }
            }
            else {
                this._endpoint = dist.SessionServiceConstants.LOGIN_TOKEN_DEFAULT;
         ...
         */
            function (value) {
                ...
                this.eventBroadcaster.broadcast(eventsV7.Broadcaster.DCM_LEGAL_ENTITY_CHANGE, JSON.stringify(value));
         ...
         */
            function (fetch, page, legalEntityCode) {
                var _this = this;
                /** @type {?} */
                var endpoint = this.http.generateEndpoint(dist.SessionServiceConstants.USER_LEGAL_ENTITIES);
                endpoint = this.addQueryParams(endpoint, fetch, page, legalEntityCode);
                return this.http.get(endpoint).pipe(operators.map(( /**
                 * @param {?} response
                 * @return {?}
                 */function (response) {
                    /** @type {?} */
                 ...
                 * @param {?} e
                 * @return {?}
                 */function (e) { return rxjs.Observable.throw(_this.handleError(e)); })));
            };
        /**
         * @param {?} method
         * @return {?}
         ...
         */
            function () {
                var _this = this;
                /** @type {?} */
                var endpoint = this.http.generateEndpoint(dist.SessionServiceConstants.USER_APPLICATION_MENU);
                return this.http.get(endpoint).pipe(operators.map(( /**
                 * @param {?} response
                 * @return {?}
                 */function (response) {
         ...
         */
            function () {
                this.clean();
                this.eventBroadcaster.broadcast(eventsV7.Broadcaster.DCM_APP_LOGOUT);
            };
        ...
        SessionService.ctorParameters = function () {
            return [
                ...
                { type: String, decorators: [{ type: core.Inject, args: [SessionService.AUTH_TOKEN_VERSION,] }, { type: core.Optional }] }
            ];
        };
    ...
    var LegalEntity = /** @class */ (function () {
        function LegalEntity(http$$1, endpoints) {
            this.http = http$$1;
        ...
        /** @nocollapse */
        LegalEntity.ctorParameters = function () {
            return [
                { type: HttpCemex },
                { type: dist.EndpointsConstants }
            ];
        };
        return LegalEntity;
    }());
    ...
    var FinancialDocuments = /** @class */ (function () {
        function FinancialDocuments(http$$1, endpoints) {
            this.http = http$$1;
            this.endpoints = endpoints;
        }
        /**
        ...
        /** @nocollapse */
        FinancialDocuments.ctorParameters = function () {
            return [
                { type: HttpCemex },
                { type: dist.EndpointsConstants }
            ];
    ...
    var AuthGuard = /** @class */ (function () {
        function AuthGuard(router$$1, sessionService) {
    ...
    var TranslationService = /** @class */ (function () {
        function TranslationService(eventBroadcaster, http$$1, _productPath, useTranslationServer, _translationUrl) {
            this.eventBroadcaster = eventBroadcaster;
            this.http = http$$1;
            ...
            this.productPath = '';
            this._localeData = new rxjs.Subject();
         ...
         */
            function (result) {
                ...
                this.eventBroadcaster.broadcast(eventsV7.Broadcaster.DCM_LANGUAGE_FETCHED, TranslationService.language);
        ...
        TranslationService.ctorParameters = function () {
            return [
                { type: eventsV7.Broadcaster },
                { type: http.Http },
                { type: String, decorators: [{ type: core.Inject, args: [TranslationService.PRODUCT_PATH,] }, { type: core.Optional }] },
                { type: Boolean, decorators: [{ type: core.Inject, args: [TranslationService.USE_TRANSLATION_SERVER,] }, { type: core.Optional }] },
                { type: String, decorators: [{ type: core.Inject, args: [TranslationService.TRANSLATION_BASE_URL,] }, { type: core.Optional }] }
            ];
        };
    ...
    var FeatureToggleService = /** @class */ (function () {
        function FeatureToggleService(eventBroadcaster, http$$1, _productPath, _productEnvironment, localManifest) {
            this.eventBroadcaster = eventBroadcaster;
            this.http = http$$1;
            this._productPath = _productPath;
        ...
        /** @nocollapse */
        FeatureToggleService.ctorParameters = function () {
            return [
                { type: eventsV7.Broadcaster },
                { type: http.Http },
                { type: String, decorators: [{ type: core.Inject, args: [FeatureToggleService.PRODUCT_PATH,] }, { type: core.Optional }] },
                { type: String, decorators: [{ type: core.Inject, args: [FeatureToggleService.ENVIRONMENT,] }, { type: core.Optional }] },
                { type: Boolean, decorators: [{ type: core.Inject, args: [FeatureToggleService.USE_LOCAL_MANIFEST,] }, { type: core.Optional }] }
            ];
        };
    ...
    var CountryConfigService = /** @class */ (function () {
        function CountryConfigService(http$$1, projectEnv, sessionService) {
            var _this = this;
            this.http = http$$1;
            this.projectEnv = projectEnv;
            this.sessionService = sessionService;
            this._countryConfig = new rxjs.BehaviorSubject(null);
         ...
         */
            function () {
                 ...
                 * @param {?} res
                 * @return {?}
                 */function (res) { return res.json(); })), operators.catchError(this.handleError));
            };
        /**
         * @private
         * @param {?} error
        ...
        /** @nocollapse */
        CountryConfigService.ctorParameters = function () {
            return [
                { type: HttpCemex },
                { type: ProjectSettings },
                { type: SessionService }
    ...
    var CashSalesService = /** @class */ (function () {
        function CashSalesService(http$$1, endpoints) {
            this.http = http$$1;
            this.endpoints = endpoints;
        ...
        /** @nocollapse */
        CashSalesService.ctorParameters = function () {
            return [
                { type: HttpCemex },
                { type: dist.EndpointsConstants }
            ];
    ...
    exports.CORE_COMMON_PROVIDERS = CORE_COMMON_PROVIDERS;
    exports.CmxCoreCommonModule = CmxCoreCommonModule;
    exports.HttpCemex = HttpCemex;
    exports.SessionService = SessionService;
    exports.LegalEntity = LegalEntity;
    exports.FinancialDocuments = FinancialDocuments;
    exports.ProjectSettings = ProjectSettings;
    exports.AuthGuard = AuthGuard;
    exports.TranslationService = TranslationService;
    exports.Logger = Logger;
    exports.FeatureToggleService = FeatureToggleService;
    exports.CountryConfigService = CountryConfigService;
    exports.EmailValidators = EmailValidators;
    exports.NumberValidators = NumberValidators;
    exports.CashSalesService = CashSalesService;
    exports.AnalyticsFactory = AnalyticsFactory;
    exports.CountlyService = CountlyService;
    exports.PushNotificationsConstants = PushNotificationsConstants;
...
//# sourceMappingURL=cemex-core-angular-services-v7.umd.js.map