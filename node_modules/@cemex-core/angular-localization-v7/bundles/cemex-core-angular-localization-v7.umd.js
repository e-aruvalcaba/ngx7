(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('moment'), require('@angular/common/http'), require('@angular/common'), require('rxjs'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@cemex-core/angular-localization-v7', ['exports', 'moment', '@angular/common/http', '@angular/common', 'rxjs', '@angular/core'], factory) :
    (factory((global['cemex-core'] = global['cemex-core'] || {}, global['cemex-core']['angular-localization-v7'] = {}),global.moment_,global.ng.common.http,global.ng.common,global.rxjs,global.ng.core));
}(this, (function (exports,moment_,http,common,rxjs,core) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TranslationService = /** @class */ (function () {
        ...
        function TranslationService(httpClient, productPath, loadedLanguages, defaultLanguageISO // e.g.: en_US from america region || en_UK from europe region.
            ...
            this.languageLoaded = new rxjs.ReplaySubject(1);
            this.selectedLanguageSubject = new rxjs.ReplaySubject(1);
            this.languagesSubject = new rxjs.ReplaySubject(1);
        ...
        TranslationService.ctorParameters = function () {
            return [
                ...
                { type: String, decorators: [{ type: core.Inject, args: [TranslationService.TRANSLATION_PRODUCT_PATH,] }, { type: core.Optional }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [TranslationService.TRANSLATION_LANGUAGES,] }, { type: core.Optional }] },
                { type: undefined, decorators: [{ type: core.Inject, args: [TranslationService.DEFAULT_LANGUAGE_ISO,] }, { type: core.Optional }] }
            ];
        };
    ...
    var FormatterService = /** @class */ (function () {
         ...
         */
            function (date, languageISO, format, action) {
                if (action === void 0) {
                    action = DateTimeActions.ConvertToLocal;
                }
    ...
    var CmxCurrencyCustomPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxCurrencyCustomPipe.ctorParameters = function () {
            return [
    ...
    var CmxCurrencyPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxCurrencyPipe.ctorParameters = function () {
            return [
                { type: FormatterService },
    ...
    var CmxDateMomentPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxDateMomentPipe.ctorParameters = function () {
            return [
                { type: TranslationService },
                { type: FormatterService }
            ];
    ...
    var CmxDatePipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxDatePipe.ctorParameters = function () {
            return [
                { type: TranslationService },
    ...
    var CmxDateTimeMomentPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxDateTimeMomentPipe.ctorParameters = function () {
            return [
                { type: TranslationService },
                { type: FormatterService }
            ];
    ...
    var CmxNumberPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxNumberPipe.ctorParameters = function () {
            return [
                { type: TranslationService },
                { type: FormatterService }
            ];
    ...
    var CmxTimeMomentPipe = /** @class */ (function () {
        ...
        /** @nocollapse */
        CmxTimeMomentPipe.ctorParameters = function () {
            return [
                { type: TranslationService },
                { type: FormatterService }
            ];
    ...
    var DirectionService = /** @class */ (function () {
        function DirectionService(translation) {
            var _this = this;
            this.translation = translation;
            this.direction$ = new rxjs.Subject();
            this.rtl$ = new rxjs.Subject();
        ...
        /** @nocollapse */
        DirectionService.ctorParameters = function () {
            return [
                { type: TranslationService }
            ];
        };
    ...
    var TranslationResolver = /** @class */ (function () {
        ...
        /** @nocollapse */
        TranslationResolver.ctorParameters = function () {
            return [
                { type: TranslationService }
            ];
        };
    ...
    exports.AngularLocalizationModule = AngularLocalizationModule;
    exports.DateTimeActions = DateTimeActions;
    ...
    exports.CmxCurrencyCustomPipe = CmxCurrencyCustomPipe;
    exports.CmxCurrencyPipe = CmxCurrencyPipe;
    exports.CmxDatePipe = CmxDatePipe;
    exports.CmxDateMomentPipe = CmxDateMomentPipe;
    exports.CmxTimeMomentPipe = CmxTimeMomentPipe;
    exports.CmxDateTimeMomentPipe = CmxDateTimeMomentPipe;
    exports.CmxNumberPipe = CmxNumberPipe;
...
//# sourceMappingURL=cemex-core-angular-localization-v7.umd.js.map